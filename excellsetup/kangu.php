...
<header>
  ...
  <section class="entries">
    <div class="m-5">
      ...
      <!--<a href="devoluções.php" class="new-entry-btn btn btn-dark">Devolução</a>-->
    </div>
        ...
        <table class="table text-white table-bg table-sm" id="tabela-lancamentos">
          ...
          <tbody>
            ...
            foreach ($registrosPesquisados as $registro) {
              ...
              <a class='btn btn-dark' href='devolucao.php?id=".$registro['id']."&acao=devolucao' id='new-entry-btn'>Devolução</a>
