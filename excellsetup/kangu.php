<?php
  ...
  // Obter os registros para a tabela atual
  $sqlLimit = "SELECT * FROM auditoria ORDER BY id DESC LIMIT $inicio, $registrosPorTabela";
  $resultLimit = $conexao->query($sqlLimit);
?>
      ...
      <div class="table-responsive">
        <table class="table text-white table-bg table-sm" id="tabela-lancamentos">
          ...
          <tbody>
            ...
            while($user_data = mysqli_fetch_assoc($resultLimit))
            { 
              echo "<tr>";
              echo "<td>".$user_data['rota']."</td>";
              echo "<td>".$user_data['nome']."</td>";
              echo "<td>".$user_data['codigo']."</td>";
              echo "<td>
                <a class='btn btn-dark' href='entrega.php?id=$user_data[id]' id='new-entry-btn'>Entregue</a>
                <a class='btn btn-dark' href='entrega.php?id=$user_data[id]' id='new-entry-btn'>Devolução</a>
              </td>";
              echo "</tr>";
            }
